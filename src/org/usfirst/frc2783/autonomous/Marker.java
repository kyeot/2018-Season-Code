 ...
 * enclosed by the <code>Marker</code> object's upper-left point {@code (x,y)}
 * in the coordinate space, its width, and its height.
 * <p>
 * A <code>Marker</code> object's <code>width</code> and <code>height</code> are
 * <code>public</code> fields. The constructors that create a
 * <code>Marker</code>, and the methods that can modify one, do not prevent
 * setting a negative value for width or height.
 * <p>
 * <a name="Empty"> A {@code Marker} whose width or height is exactly zero has
 * location along those axes with zero dimension, but is otherwise considered
 * empty. The {@link #isEmpty} method will return true for such a
 * {@code Marker}. Methods which test if an empty {@code Marker} contains or
 * intersects a point or Marker will always return false if either dimension is
 * zero. Methods which combine such a {@code Marker} with a point or Marker will
 * include the location of the {@code Marker} on that axis in the result as if
 * the {@link #add(Point)} method were being called. </a>
 * <p>
 * <a name="NonExistant"> A {@code Marker} whose width or height is negative has
 * neither location nor dimension along those axes with negative dimensions.
 * Such a {@code Marker} is treated as non-existant along those axes. Such a
 * {@code Marker} is also empty with respect to containment calculations and
 * methods which test if it contains or intersects a point or Marker will always
 * return false. Methods which combine such a {@code Marker} with a point or
 * Marker will ignore the {@code Marker} entirely in generating the result. If
 * two {@code Marker} objects are combined and each has a negative dimension,
 * the result will have at least one negative dimension. </a>
 * <p>
 * Methods which affect only the location of a {@code Marker} will operate on
 ...
 * {@code Marker} will still have a location of {@code (0,0)} and will
 ...
 * the {@code Marker} with a specifically negative width and height or it should
 * use the first point in the set to construct the {@code Marker}. For example:
 * 
 * <pre>
 ...
 * @since 1.0
 */
public class Marker extends Rectangle2D implements Shape, java.io.Serializable {
	...
	/**
	 * Constructs a new <code>Marker</code> whose upper-left corner is at
	...
	/**
	 * Constructs a new <code>Marker</code>, initialized to match the values of
	 * the specified <code>Marker</code>.
	 * 
	 * @param r
	 *            the <code>Marker</code> from which to copy initial values to a
	 *            newly constructed <code>Marker</code>
	 * @since 1.1
	 */
	public Marker(Marker r) {
		this(r.x, r.y, r.width, r.height);
	}

	/**
	 * Constructs a new <code>Marker</code> whose upper-left corner is specified
	...
	public Marker(int x, int y, int width, int height, boolean isSelected) {
		this.x = x + (width / 2);
		this.y = y + (height / 2);
		this.width = width;
		this.height = height;
	...
	/**
	 * Constructs a new <code>Marker</code> whose upper-left corner is specified
	 * by the {@link Point} argument, and whose width and height are specified
	 * by the {@link Dimension} argument.
	 * 
	 * @param p
	 ...
	 */
	public Marker(Point p, Dimension d) {
	...
	/**
	 * Constructs a new <code>Marker</code> whose top left corner is (0,&nbsp;0)
	...
	public Rectangle2D getBounds2D1() {
		return new Marker(x, y, width, height);
	}

	/**
	 * Sets the bounding <code>Marker</code> of this <code>Marker</code> to
	 * match the specified <code>Marker</code>.
	 * <p>
	 ...
	 * @since 1.1
	 */
	public void setBounds(Marker r) {
		setBounds(r.x, r.y, r.width, r.height);
	}

	/**
	 * Sets the bounding <code>Marker</code> of this <code>Marker</code> to the
	 * specified <code>x</code>, <code>y</code>, <code>width</code>, and
	 * <code>height</code>.
	 * <p>
	 * This method is included for completeness, to parallel the
	 * <code>setBounds</code> method of <code>Component</code>.
	 ...
	 *            <code>Marker</code>
	 * @param width
	 *            the new width for this <code>Marker</code>
	 * @param height
	 *            the new height for this <code>Marker</code>
	 * @see #getBounds
	...
	/**
	 * Sets the bounds of this {@code Marker} to the integer bounds which
	 * encompass the specified {@code x}, {@code y}, {@code width}, and
	 * {@code height}. If the parameters specify a {@code Marker} that exceeds
	 * the maximum range of integers, the result will be the best representation
	 * of the specified {@code Marker} intersected with the maximum integer
	 * bounds.
	 * 
	 * @param x
	 ...
	 *            Marker
	 * @param width
	 *            the width of the specified Marker
	 * @param height
	 *            the new height of the specified Marker
	 */
	...
	/**
	 * Translates this <code>Marker</code> the indicated distance, to the right
	 * along the X coordinate axis, and downward along the Y coordinate axis.
	 * 
	 * @param dx
	 *            the distance to move this <code>Marker</code> along the X axis
	 * @param dy
	 *            the distance to move this <code>Marker</code> along the Y axis
	...
	/**
	 * Gets the size of this <code>Marker</code>, represented by the returned
	 * <code>Dimension</code>.
	 * <p>
	 * This method is included for completeness, to parallel the
	...
	/**
	 * Sets the size of this <code>Marker</code> to match the specified
	 * <code>Dimension</code>.
	 * <p>
	 * This method is included for completeness, to parallel the
	...
	/**
	 * Sets the size of this <code>Marker</code> to the specified width and
	 * height.
	 * <p>
	 * This method is included for completeness, to parallel the
	 * <code>setSize</code> method of <code>Component</code>.
	...
	/**
	 * Checks whether or not this <code>Marker</code> contains the specified
	 * <code>Point</code>.
	 * 
	 * @param p
	 *            the <code>Point</code> to test
	 * @return <code>true</code> if the specified <code>Point</code> is inside
	 *         this <code>Marker</code>; <code>false</code> otherwise.
	 * @since 1.1
	 */
	...
	/**
	 * Checks whether or not this <code>Marker</code> contains the point at the
	...
	/**
	 * Checks whether or not this <code>Marker</code> entirely contains the
	 * specified <code>Marker</code>.
	 *
	 * @param r
	 *            the specified <code>Marker</code>
	 * @return <code>true</code> if the <code>Marker</code> is contained
	 *         entirely inside this <code>Marker</code>; <code>false</code>
	 *         otherwise
	 * @since 1.2
	 */
	public boolean contains(Marker r) {
		return contains(r.x, r.y, r.width, r.height);
	}

	/**
	 * Checks whether this <code>Marker</code> entirely contains the
	 * <code>Marker</code> at the specified location {@code (X,Y)} with the
	 ...
	 * <code>Marker</code> intersect. Two Rectangles intersect if their
	 * intersection is nonempty.
	 *
	 * @param r
	 *            the specified <code>Marker</code>
	 * @return <code>true</code> if the specified <code>Marker</code> and this
	 *         <code>Marker</code> intersect; <code>false</code> otherwise.
	 */
	public boolean intersects(Marker r) {
		int tw = this.width;
		int th = this.height;
		int rw = r.width;
		int rh = r.height;
	...
	/**
	 * Computes the intersection of this <code>Marker</code> with the specified
	 * <code>Marker</code>. Returns a new <code>Marker</code> that represents
	 * the intersection of the two Rectangles. If the two Rectangles do not
	 * intersect, the result will be an empty Marker.
	 *
	 * @param r
	 *            the specified <code>Marker</code>
	 * @return the largest <code>Marker</code> contained in both the specified
	 *         <code>Marker</code> and in this <code>Marker</code>; or if the
	 *         Rectangles do not intersect, an empty Marker.
	 */
	public Marker intersection(Marker r) {
		int tx1 = this.x;
		int ty1 = this.y;
		int rx1 = r.x;
		int ry1 = r.y;
		...
		return new Marker(tx1, ty1, (int) tx2, (int) ty2);
	}

	/**
	 * Computes the union of this <code>Marker</code> with the specified
	 * <code>Marker</code>. Returns a new <code>Marker</code> that represents
	 * the union of the two Rectangles.
	 * <p>
	 * If either {@code Marker} has any dimension less than zero the rules for
	 ...
	 * {@code Marker}. If both have dimension less than zero, then the result
	 * will have at least one dimension less than zero.
	 * <p>
	 * If the resulting {@code Marker} would have a dimension too large to be
	 * expressed as an {@code int}, the result will have a dimension of
	 * {@code Integer.MAX_VALUE} along that dimension.
	 * 
	 * @param r
	 *            the specified <code>Marker</code>
	 * @return the smallest <code>Marker</code> containing both the specified
	 *         <code>Marker</code> and this <code>Marker</code>.
	 */
	public Marker union(Marker r) {
		long tx2 = this.width;
	 ...
	 * bounds of this {@code Marker}.
	 * <p>
	 * If this {@code Marker} has any dimension less than zero, the rules for
	 * <a href=#NonExistant>non-existant</a> Rectangles apply. In that case, the
	 * new bounds of this {@code Marker} will have a location equal to the
	 ...
	 * on the right or bottom edges of a <code>Marker</code>. Therefore, if the
	 * added point falls on the right or bottom edge of the enlarged
	 * <code>Marker</code>, <code>contains</code> returns <code>false</code> for
	...
	/**
	 * Adds the specified {@code Point} to the bounds of this {@code Marker}.
	 * <p>
	 * If this {@code Marker} has any dimension less than zero, the rules for
	 * <a href=#NonExistant>non-existant</a> Rectangles apply. In that case, the
	 * new bounds of this {@code Marker} will have a location equal to the
	 ...
	 * <code>Marker</code>. Therefore if the added <code>Point</code> falls on
	 * the right or bottom edge of the enlarged <code>Marker</code>,
	 * <code>contains</code> returns <code>false</code> for that
	 * <code>Point</code>. If the specified point must be contained within the
	 * new {@code Marker}, a 1x1 Marker should be added instead:
	 * 
	 * <pre>
	 * r.add(pt.x, pt.y, 1, 1);
	 * </pre>
	 * 
	 * @param pt
	 *            the new <code>Point</code> to add to this <code>Marker</code>
	 */
	...
	/**
	 * Adds a <code>Marker</code> to this <code>Marker</code>. The resulting
	 * <code>Marker</code> is the union of the two Rectangles.
	 * <p>
	 * If either {@code Marker} has any dimension less than 0, the result will
	 * have the dimensions of the other {@code Marker}. If both {@code Marker}s
	 * have at least one dimension less than 0, the result will have at least
	 * one dimension less than 0.
	 * <p>
	 * If either {@code Marker} has one or both dimensions equal to 0, the
	 ...
	 * result Marker along that axis, similar to the operation of the
	 ...
	 * <p>
	 * This method modifies the <code>Marker</code> so that it is <code>h</code>
	 * units larger on both the left and right side, and <code>v</code> units
	 * larger at both the top and bottom.
	 * <p>
	 * The new <code>Marker</code> has {@code (x - h, y - v)} as its upper-left
	 * corner, width of {@code (width + 2h)}, and a height of
	 * {@code (height + 2v)}.
	 * <p>
	 * If negative values are supplied for <code>h</code> and <code>v</code>,
	 * the size of the <code>Marker</code> decreases accordingly. The
	 ...
	 * <code>null</code> and is a <code>Marker</code> object that has the same
	 * upper-left corner, width, and height as this <code>Marker</code>.
	 * 
	 * @param obj
	...
	/**
	 * Returns a <code>String</code> representing this <code>Marker</code> and
	 * its values.
	 * 
	 * @return a <code>String</code> representing this <code>Marker</code>
