...
public class AdaptivePurePursuitController {
	...
	/**
	 * This class does exactly what the name says. It is a class full of
	 * different kinds of data that are used to help the robot understand it's
	...
	public static class Command {
		...
		public double cross_track_error; // how much it's off track? I'm not
											// sure about this one.
		public double max_velocity; // The max speed
		public double end_velocity; // The speed in which the robot reaches
									// desired point
		public Translation2d lookahead_point; // The desired point of the robot
		public double remaining_path_length; // The length of the path needed to
												// be driven
	...
	public Command update(RigidTransform2d pose) {
		if (mReversed) {
			pose = new RigidTransform2d(pose.getTranslation(),
					pose.getRotation().rotateBy(Rotation2d.fromRadians(Math.PI))); // Just
																					// creates
																					// a
																					// new
																					// pose
