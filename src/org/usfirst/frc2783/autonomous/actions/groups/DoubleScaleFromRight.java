...
public class DoubleScaleFromRight extends ActionGroup{

	public DoubleScaleFromRight(){
		super();
		...
		try{
			if(!Robot.isScaleLeft()){
				...
				addAction(new RotateTankAction(new Bearing(154), 1));
				...
				addAction(new RotateTankAction(new Bearing(9), 1));
				addAction(new AutoElevator(-1, 1.5));
