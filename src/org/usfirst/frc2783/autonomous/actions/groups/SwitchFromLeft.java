		...
		try{
			if(!Robot.switchAutoIsFront){
				if(Robot.isSwitchesLeft()){		
					...
					addAction(new RotateTankAction(new Bearing(270), 1.5));
					...
					addAction(new RotateTankAction(new Bearing(271), 1.5));
					addAction(new DriveWithGyroAndByDistance(0.5, 38.5*12, 38.5*12, 271));
					addAction(new RotateTankAction(new Bearing(180), 1.5));
					addAction(new AutoDrive(0.5, 0.5, 1));
					addAction(new RotateTankAction(new Bearing(90), 1.5));
				...
				if(Robot.isSwitchesLeft()){		
					...
					addAction(new RotateTankAction(new Bearing(0), 1.5));
					addAction(new AutoElevator(-1, 1.25)); 
