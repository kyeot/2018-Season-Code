...
public class RightScaleToRightStage implements PathContainer{

	@Override
	public Path buildPath() {
		ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
		sWaypoints.add(new Waypoint(StaticSetpoints.scaleRight, 0, 0));
	...
	public RigidTransform2d getStartPose() {
		return new RigidTransform2d(StaticSetpoints.scaleRight, Rotation2d.fromDegrees(0));
	}
