...
public class LeftStageToLeftSwitch implements PathContainer{

	@Override
	public Path buildPath() {
		ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
		sWaypoints.add(new Waypoint(StaticSetpoints.leftOfSwitch, 0, 0));
		...
		sWaypoints.add(new Waypoint(StaticSetpoints.switchLeft, 0, 60));
	...
	public RigidTransform2d getStartPose() {
		return new RigidTransform2d(StaticSetpoints.leftOfSwitch, Rotation2d.fromDegrees(0));
	}
