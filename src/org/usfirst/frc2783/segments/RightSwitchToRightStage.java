...
public class RightSwitchToRightStage implements PathContainer{

	@Override
	public Path buildPath() {
		ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
		sWaypoints.add(new Waypoint(StaticSetpoints.switchRight, 0, 0));
	...
	public RigidTransform2d getStartPose() {
		return new RigidTransform2d(StaticSetpoints.switchRight, Rotation2d.fromDegrees(180));
	}
